  ...
  const renderProfile = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="mt-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">NAICS Codes</label>
          <input
            type="text"
            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            placeholder="Enter your primary NAICS codes (comma-separated)"
          />
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-medium text-gray-900">New Matching Opportunities</h4>
              <p className="text-sm text-gray-500">Get notified when new contracts match your profile</p>
            </div>
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Building className="h-8 w-8 text-blue-600" />
              <h1 className="ml-3 text-xl font-bold text-gray-900">GovContract Tracker</h1>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-600">
                Plan: <span className="font-medium text-blue-600 capitalize">{userTier}</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <nav className="flex space-x-8 mb-8">
          {[
            ...
            { id: 'search', label: 'Search Contracts', icon: Search },
            { id: 'saved', label: 'Saved Contracts', icon: Bookmark },
            { id: 'profile', label: 'Profile & Alerts', icon: Users },
            { id: 'pricing', label: '💎 Upgrade', icon: DollarSign }
            ...
            <button
              ...
              } ${id === 'pricing' ? 'text-purple-600 hover:text-purple-700' : ''}`}
            >
        ...
        {activeTab === 'pricing' && renderPricingModal()}
      </div>
    </div>
  );
};
